...
static std::string configToButtonName(std::string configName)
{
  if (configName == "KEY_A")
    return "\uE0E0";
  else if (configName == "KEY_B")
    return "\uE0E1";
  else if (configName == "KEY_X")
    return "\uE0E2";
  else if (configName == "KEY_Y")
    return "\uE0E3";
  else if (configName == "KEY_LSTICK")
    return "\uE104";
  else if (configName == "KEY_RSTICK")
    return "\uE105";
  else if (configName == "KEY_L")
    return "\uE0E4";
  else if (configName == "KEY_R")
    return "\uE0E5";
  else if (configName == "KEY_ZL")
    return "\uE0E6";
  else if (configName == "KEY_ZR")
    return "\uE0E7";
  else if (configName == "KEY_PLUS")
    return "\uE0EF";
  else if (configName == "KEY_MINUS")
    return "\uE0F0";
  else if (configName == "KEY_DLEFT")
    return "\uE0ED";
  else if (configName == "KEY_DUP")
    return "\uE0EB";
  else if (configName == "KEY_DRIGHT")
    return "\uE0EE";
  else if (configName == "KEY_DDOWN")
    return "\uE0EC";
  else
    return "\uE0E0";
}
...
void GuiHIDMitm::draw()
{
  ...
  Gui::drawTextAligned(font24, 70, 58, currTheme.textColor, "        Stellar Toolbox", ALIGNED_LEFT);
